...
import com.kmx.newsapp.databinding.FragmentSavedBinding
...
class SavedFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val itemToucheHelperCallback = object : ItemTouchHelper.SimpleCallback(
        ...
        ItemTouchHelper(itemToucheHelperCallback).apply {
